//////////////////////////////////////////////////////
// file: SMath.h @ 2008-1-19 by Zhang Xiang
//
...
namespace CAPG{
	...
	*/
	...
	public:
		...
		explicit Fixed16(Real s) : m_decimal((uShort)((s - m_whole) * 65536)), m_whole((int)std::floor(s)) {
		}
	...
	*/
	...
	public:
		...
		// defines for Tolerance in compare
