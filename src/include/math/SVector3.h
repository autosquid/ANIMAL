//////////////////////////////////////////////////////
// file: SVector3.h @ 2008-1-21 by Zhang Xiang
...
#pragma pack(1)
	...
	*/
	...
	public:
		...
		inline Vector3(const Euler& euler) : m_fx(euler.x()), m_fy(euler.y()), m_fz(euler.z()){}
	...
	public:
		...
		*/
		...
		/** Calculates the Vector3 after multy the other Vector3.
			@remarks
				Used to scale the x,y,z with the other's x,y,z, rarely use
			@param
				other is used as the scale factor
			@returns
				Vector3 after scaling.
		*/
		inline Vector3 scaling(const Vector3& other) const
		{
			return Vector3(m_fx * other.x(), m_fy * other.y(), m_fz * other.z());
		}
		...
		*/
		...
		inline _CAPGExport friend std::ostream& operator << (std::ostream &o, const Vector3 &v){
