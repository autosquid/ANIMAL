//////////////////////////////////////////////////////
// file: SQuaternion.h @ 2008-1-24 by Zhang Xiang
...
namespace CAPG{
	...
	*/
	...
	public:
        ...
        /// Construct a quaternion that rotate one vector to the other
...
//added by wz. Jan. 25
		...
		*/
		...
		_CAPGExport friend Quaternion operator * (const Real vfScalar, const Quaternion& vqrq);
		...
		bool isIdentity(void) const{
			return Math::RealEqual(m_fx, 0) && Math::RealEqual(m_fy, 0) && Math::RealEqual(m_fz, 0);
		}
		/// dot product
		...
		*/
		...
		Euler toEuler(Euler::RotateOrder ro) const;
		//////////////////////////////////////////////////////////////////////////
		
		
		//! new added method by wz.
		...
		//! new added method
		Quaternion decomposeRotation(const Vector3& vB)const;
		

		/** Function for writing to a stream. Outputs "Quaternion(w, x, y, z)" with w,x,y,z
            being the member values of the quaternion.
        */
		inline _CAPGExport friend std::ostream& operator << (std::ostream& o, const Quaternion& q){
