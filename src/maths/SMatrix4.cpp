//////////////////////////////////////////////////////
// file: SMatrix4.cpp @ 2008-1-30 by Zhang Xiang
// defines of the class SMatrix4
// SMatrix4 is a class ...
//////////////////////////////////////////////////////
...
namespace CAPG{
	...
	float Matrix4::determinant() const{
		return m_fm[0][0] * MINOR(*this, 1, 2, 3, 1, 2, 3) -
				m_fm[0][1] * MINOR(*this, 1, 2, 3, 0, 2, 3) +
				m_fm[0][2] * MINOR(*this, 1, 2, 3, 0, 1, 3) -
				m_fm[0][3] * MINOR(*this, 1, 2, 3, 0, 1, 2);
	}

	Matrix4 Matrix4::inverse() const{
		float m00 = m_fm[0][0], m01 = m_fm[0][1], m02 = m_fm[0][2], m03 = m_fm[0][3];
		float m10 = m_fm[1][0], m11 = m_fm[1][1], m12 = m_fm[1][2], m13 = m_fm[1][3];
		float m20 = m_fm[2][0], m21 = m_fm[2][1], m22 = m_fm[2][2], m23 = m_fm[2][3];
		float m30 = m_fm[3][0], m31 = m_fm[3][1], m32 = m_fm[3][2], m33 = m_fm[3][3];
	...
	void Matrix4::makeTransform(const Vector3& position, const Vector3& scale, const Quaternion& orientation){
		...
		*this = rot3x3 * scale3x3;
		...
		// No projection term
		m_fm[3][0] = 0; m_fm[3][1] = 0; m_fm[3][2] = 0; m_fm[3][3] = 1;
	}
