//////////////////////////////////////////////////////
// file: SMatrix.h @ 2008-1-20 by Zhang Xiang
// declares of the class Matrix3
// Matrix3 is a class ...
//////////////////////////////////////////////////////
#ifndef __SMATRIX3_H__
#define __SMATRIX3_H__
...
namespace CAPG{
	...
	*/
	...
	public:
		...
		_CAPGExport friend Vector3 operator * (const Vector3& vvrv, const Matrix3& vmrm);

		/// matrix * scalar
		Matrix3 operator * (const Real vfScalar) const;

		/// scalar * matrix
		_CAPGExport friend Matrix3 operator * (const Real vfScalar, const Matrix3& vmrm);
